  ...
  return (
    <section className="hospital-intro">
      <div className="intro-left">
        ...
        <p>
          <strong>Anmol Hospital</strong> is a trusted multi-specialty hospital located in Kamla Nehru Nagar, Indore, serving the community since <strong>2019</strong> We started with a clear and honest mission to provide affordable, ethical, and 
            compassionate healthcare to every individual and family.
           
        </p>
        <p>
           Founded by <strong>Dr. Jitendra Awasthi (BHMS, PGDEMS, MHA)</strong> and <strong>Dr. Shivam Mishra (BHMS, CMSED)</strong>, the hospital is built on a strong foundation of medical expertise, patient care, and community trust. Both doctors
           ...
           <p>Over the years, we’ve earned the trust of many families by being there when they needed us most.
            Whether it's a general consultation, emergency, or specialized treatment, our team ensures every patient receives personal attention, respect, and quality care.
